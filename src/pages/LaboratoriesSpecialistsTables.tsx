            ...
            {asCard ? (
                <Card className="border-slate-200 bg-white flex flex-col flex-1 min-h-0 overflow-hidden">
                    <div className="p-0 flex-1 min-h-0 overflow-auto">
                        <Table ref={labsTableRef} className="min-w-[800px] md:min-w-full">
                            <colgroup>
                                <col style={{ width: '40%' }} />
                                <col style={{ width: '30%' }} />
                                <col style={{ width: '30%' }} />
    ...
    return (
        <>
            {asCard ? (
                <Card className="border-slate-200 bg-white flex flex-col flex-1 min-h-0 overflow-hidden">
                    <div className="p-0 flex-1 min-h-0 overflow-auto">
                        <Table ref={specsTableRef} className="min-w-[800px] md:min-w-full">
                            <colgroup>
                                <col style={{ width: '30%' }} />
                                <col style={{ width: '30%' }} />
                                <col style={{ width: '20%' }} />
    ...
    return (
        <>
            {asCard ? (
                <Card className="border-slate-200 bg-white flex flex-col flex-1 min-h-0 overflow-hidden">
                    <div className="p-0 flex-1 min-h-0 overflow-auto">
                        <Table ref={patientsTableRef} className="min-w-[800px] md:min-w-full">
                            <colgroup>
                                <col style={{ width: '15%' }} />
                                <col style={{ width: '30%' }} />
                                <col style={{ width: '15%' }} />
